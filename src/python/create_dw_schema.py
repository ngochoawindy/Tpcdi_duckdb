...
parser = argparse.ArgumentParser(description="Set up the DuckDB database - Data Warehouse Schema for TPC-DI benchmarking")
...
'''
print(f'Creating Data Warehouse Schema for scale factor {scale}')
con.sql(query)
print(f'Finished setting up Data Warehouse Schema.')