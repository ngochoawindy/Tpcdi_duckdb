...
def run_TransformTradeType(con):
    sql_trade_type = '../../sql/historical/load_tradetype.sql'
...
def run_TransformStatusType(con):
    sql_status_type = '../../sql/historical/statustype.sql'
...
def run_TransformTaxRate(con):
    sql_tax_rate = '../../sql/historical/taxrate.sql'
...
def run_TransformIndustry(con):
    sql_industry = '../../sql/historical/industry.sql'
...
def run_TransformDimDate(con):
    sql_dimdate = '../../sql/historical/dimdate.sql'
...
def run_TransformDimTime(con):
    sql_dimtime = '../../sql/historical/dimtime.sql'
...
def run_TransformDimCompany(con):
    sql_dimcompany = '../../sql/historical/dimcompany.sql'
    sql_dimmessage_dimcompany = '../../sql/historical/dimcompany_dimessages.sql'
...
def run_TransformDimBroker(con):
    sql_dimbroker = '../../sql/historical/dimbroker.sql'
...
def run_TransformProspect(con):
    sql_prospect = '../../sql/historical/prospect.sql'
...
def run_TransformDimCustomer(con):
    sql_dim_customer = '../../sql/historical/dimcustomer.sql'
    sql_dim_customer_message = '../../sql/historical/dimcustomer_dimmessage.sql'
    ...
    sql_update_prospect = '../../sql/historical/update_prospect.sql'
...
def run_TransformDimAccount(con):
    sql_dimaccount = '../../sql/historical/dimaccount.sql'
...
def run_TransformDimSecurity(con):
    sql_dimsecurity = '../../sql/historical/dimsecurity.sql'
...
def run_TransformDimTrade(con):
    sql_trade_joined = '../../sql/historical/trade_joined.sql'
    sql_dimtrade = '../../sql/historical/dimtrade.sql'
    sql_dimtrade_message = '../../sql/historical/dimessages_dimtrade.sql'
...
def run_TransformFinancial(con):
    sql_financial = '../../sql/historical/financial.sql'
...
def run_TransformFactCashBalances(con):
    sql_fact_cash_balances = '../../sql/historical/fact_cash_balances.sql'
...
def run_TransformFactHoldings(con):
    sql_fact_holdings = '../../sql/historical/factholdings.sql'
...
def run_TransformFactWatches(con):
    sql_fact_watches = '../../sql/historical/factwatches.sql'
...
def run_TransformFactMarketHistory(con):
    sql_fact_market_history = '../../sql/historical/factmarkethistory.sql'
    sql_fact_market_history_message = '../../sql/historical/factmarkethistory_dimessages.sql'
